...
class TestTimeRecorderConstructor:
    """Tests for TimeRecorder.__init__."""
    ...
    @pytest.mark.fast
    def test_init_missing_seconds_in_time(self) -> None:
    ...
    @pytest.mark.fast
    def test_init_invalid_time_format_raises(self) -> None:
    ...
    @pytest.mark.fast
    def test_init_start_time_after_end_time_raises(self) -> None:
    ...
    @pytest.mark.fast
    def test_init_negative_lunch_break_raises(self) -> None:
    ...
    @pytest.mark.fast
    def test_init_zero_duration_raises(self) -> None:
