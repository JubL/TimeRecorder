...
@pytest.mark.fast
def test_record_into_df_creates_and_appends_row(tmp_path: pathlib.Path, line: tr.TimeRecorder) -> None:
...
@pytest.mark.fast
def test_create_df_creates_file_with_correct_columns(tmp_path: pathlib.Path, line: tr.TimeRecorder) -> None:
