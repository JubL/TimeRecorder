...
class TestCalculateWorkDuration:
    """Tests for TimeRecorder.calculate_work_duration."""
    ...
    @pytest.mark.fast
    def test_standard_duration(self, sample_line: tr.TimeRecorder) -> None:
    ...
    @pytest.mark.fast
    def test_no_lunch_break(self, sample_line: tr.TimeRecorder) -> None:
    ...
    @pytest.mark.fast
    def test_short_shift(self, sample_line: tr.TimeRecorder) -> None:
    ...
    @pytest.mark.fast
    def test_start_time_after_end_time_raises(self, sample_line: tr.TimeRecorder) -> None:
    ...
    @pytest.mark.fast
    def test_negative_lunch_break_raises(self, sample_line: tr.TimeRecorder) -> None:
    ...
    @pytest.mark.fast
    def test_zero_or_negative_work_duration_raises(self, sample_line: tr.TimeRecorder) -> None:
