...
@pytest.mark.fast
def test_constructor_data_filtering_exact_months(sample_config: dict) -> None:
...
@pytest.mark.fast
def test_constructor_data_filtering_more_than_num_months(sample_config: dict) -> None:
    ...
    visualization_config = cu.get_visualization_config(sample_config)
    visualization_config["num_months"] = 3  # Only last 3 months
...
@pytest.mark.fast
def test_constructor_data_filtering_less_than_num_months(sample_config: dict) -> None:
    ...
    visualization_config = cu.get_visualization_config(sample_config)
    visualization_config["num_months"] = 3  # Request 3 months but only have 1
...
@pytest.mark.fast
def test_constructor_data_filtering_zero_months(sample_config: dict) -> None:
...
@pytest.mark.fast
def test_constructor_data_filtering_negative_months(sample_config: dict) -> None:
...
@pytest.mark.fast
def test_constructor_data_filtering_single_day(sample_config: dict) -> None:
...
@pytest.mark.fast
def test_constructor_data_filtering_irregular_dates(sample_config: dict) -> None:
    ...
    visualization_config = cu.get_visualization_config(sample_config)
    visualization_config["num_months"] = 2  # Last 2 months
...
@pytest.mark.fast
def test_constructor_data_filtering_leap_year(sample_config: dict) -> None:
    ...
    visualization_config = cu.get_visualization_config(sample_config)
    visualization_config["num_months"] = 1  # Last 1 month
...
@pytest.mark.fast
def test_constructor_data_filtering_year_boundary(sample_config: dict) -> None:
...
@pytest.mark.fast
def test_constructor_data_filtering_very_large_num_months(sample_config: dict) -> None:
...
@pytest.mark.fast
def test_constructor_data_filtering_float_num_months(sample_config: dict) -> None:
    ...
    visualization_config = cu.get_visualization_config(sample_config)
    visualization_config["num_months"] = 2.5  # Float months - should raise ValueError
